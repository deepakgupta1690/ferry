...
const Roundtrip1 = ({ updateStateValuesrt1 }) => {
...
const amenities = (e) => {
  ...
  if(selectedamenities === "Business"){
    document.getElementById("amenities-Businessrt1").style.display = "block";
    document.getElementById("amenities-Premiumrt1").style.display = "none";
    document.getElementById("amenities-Luxuryrt1").style.display = "none";
    document.getElementById("amenities-Royalrt1").style.display = "none";
    document.getElementById("amenities-Economyrt1").style.display = "none";
  }

  if(selectedamenities === "Premium"){
    document.getElementById("amenities-Premiumrt1").style.display = "block";
    document.getElementById("amenities-Businessrt1").style.display = "none";
    document.getElementById("amenities-Luxuryrt1").style.display = "none";
    document.getElementById("amenities-Royalrt1").style.display = "none";
    document.getElementById("amenities-Economyrt1").style.display = "none";
  }
  ...
  if(selectedamenities === "Economy"){
    document.getElementById("amenities-Economyrt1").style.display = "block";
    document.getElementById("amenities-Luxuryrt1").style.display = "none";
    document.getElementById("amenities-Royalrt1").style.display = "none";
    document.getElementById("amenities-Premiumrt1").style.display = "none";
    document.getElementById("amenities-Businessrt1").style.display = "none";
  ...
  if(selectedamenities === "Royal"){
    document.getElementById("amenities-Royalrt1").style.display = "block";
    document.getElementById("amenities-Luxuryrt1").style.display = "none";
    document.getElementById("amenities-Economyrt1").style.display = "none";
    document.getElementById("amenities-Premiumrt1").style.display = "none";
    document.getElementById("amenities-Businessrt1").style.display = "none";
  ...
  if(selectedamenities === "Luxury"){
    document.getElementById("amenities-Luxuryrt1").style.display = "block";
    document.getElementById("amenities-Royalrt1").style.display = "none";
    document.getElementById("amenities-Economyrt1").style.display = "none";
    document.getElementById("amenities-Premiumrt1").style.display = "none";
    document.getElementById("amenities-Businessrt1").style.display = "none";
...
useEffect(() => {
    ...
    updateStateValuesrt1(ferryName, departureTime, arrivalTime, adultprice, childprice, selectedamenitie);
  }, [ferryName, departureTime, arrivalTime, adultprice, childprice,selectedamenitie, updateStateValuesrt1]);

return (
  <>
    <div className="card mb-3" id='nautika_litert1' style={{maxWidth:"100%"}}>
        <div className="row g-0">
            ...
            <div className='col-md-4'>
                <div className="booking-details-amenities pad-3" id="amenities-Premiumrt1" style={{display:"none"}}>
                ...
                <div className="booking-details-amenities pad-3" id="amenities-Businessrt1" style={{display:"none"}}>
    ...
    <div className="card mb-3" id='green_oceanrt1' style={{maxWidth:"100%"}}>
        <div className="row g-0">
            <div className="col-md-3">
                <img src="https://ocean.go2andaman.com/wp-content/uploads/2019/10/627D1A64-C7A1-4CD7-AD2C-3F6A0EF84A17_4_5005_c.jpeg?compress=true&quality=90&w=576&dpr=1.0" style={{height:"100%"}} className="img-fluid rounded-start" alt="..." />
            </div>
            ...
            <div className='col-md-4'>
                <div className="booking-details-amenities pad-3" id="amenities-Economyrt1" style={{display:"none"}}>
                ...
                <div className="booking-details-amenities pad-3" id="amenities-Luxuryrt1" style={{display:"none"}}>
                ...
                <div className="booking-details-amenities pad-3" id="amenities-Royalrt1" style={{display:"none"}}>
