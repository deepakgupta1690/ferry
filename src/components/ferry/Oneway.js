...
const Oneway = ({ updateStateValues }) => {
  ...
  useEffect(() => {
    ...
    updateStateValues(ferryName, departureTime, arrivalTime, adultprice, childprice, selectedamenitie);
  }, [ferryName, departureTime, arrivalTime, adultprice, childprice,selectedamenitie, updateStateValues]);

  return (
    <>
      <div className="card mb-3" id='nautika_lite' style={{maxWidth:"100%"}}>
          <div className="row g-0">
                      ...
                      <div className='row'>
                          <div>
                              ...
                              <label className="type-label" style={{marginLeft:"20%"}}>
                                  <input className="type-box" type="radio" name="seat_type_120" onChange={amenities} data-ferryname="Nautika Lite" data-depttime="6:30 am" data-arrivaltime="8:15 am" data-adultprice="1650" data-childprice="174" value="Business"/>
                                    <div className="green-roundborder is-flex flex-column align-items-center justify-content-center">
                                  <div>
              ...
              <div className='col-md-4'>
                  <div className="booking-details-amenities pad-3" id="amenities-Premium" style={{display:"none"}}>
                  ...
                  <div className="booking-details-amenities pad-3" id="amenities-Business" style={{display:"none"}}>
      ...
      <div className="card mb-3" id='green_ocean' style={{maxWidth:"100%"}}>
          <div className="row g-0">
              <div className="col-md-3">
                  <img src="https://ocean.go2andaman.com/wp-content/uploads/2019/10/627D1A64-C7A1-4CD7-AD2C-3F6A0EF84A17_4_5005_c.jpeg?compress=true&quality=90&w=576&dpr=1.0" style={{height:"100%"}} className="img-fluid rounded-start" alt="..." />
              </div>
                      ...
                      <div className='row'>
                          <div>
                              <label className="type-label" style={{marginLeft:"5%"}}>
                                  <input className="type-box" type="radio" name="seat_type_120" onChange={amenities} data-ferryname="Green Ocean" data-depttime="7:00 am" data-arrivaltime="9:15 am" data-adultprice="1100" data-childprice="174" value="Economy" />
                                    <div className="green-roundborder is-flex flex-column align-items-center justify-content-center">
                                        <div>
                              ...
                              <label className="type-label" style={{marginLeft:"5%"}}>
                                  <input className="type-box" type="radio" name="seat_type_120" onChange={amenities} data-ferryname="Green Ocean" data-depttime="7:00 am" data-arrivaltime="9:15 am" data-adultprice="1450" data-childprice="174" value="Luxury"/>
                                  <div className="green-roundborder is-flex flex-column align-items-center justify-content-center">
                                      <div>
                                          <span className="font16 discounted-price pb-1">₹1,450</span>
                                          <br></br>
                              ...
                              <label className="type-label" style={{marginLeft:"5%"}}>
                                  <input className="type-box" type="radio" name="seat_type_120" onChange={amenities} data-ferryname="Green Ocean" data-depttime="7:00 am" data-arrivaltime="9:15 am" data-adultprice="1650" data-childprice="174" value="Royal"/>
                                  <div className="green-roundborder is-flex flex-column align-items-center justify-content-center">
                                      <div>
                                      <span className="font16 discounted-price pb-1">₹1,650</span>
                                      <br></br>
