...
const Multipletrip1 = ({ updateStateValuesmt1 }) => {
  ...
  useEffect(() => {
    ...
    updateStateValuesmt1(ferryName, departureTime, arrivalTime, adultprice, childprice, selectedamenitie);
  }, [ferryName, departureTime, arrivalTime, adultprice, childprice,selectedamenitie, updateStateValuesmt1]);

  return (
    <>
      <div className="card mb-3" id='nautika_litemt1' style={{maxWidth:"100%"}}>
          <div className="row g-0">
              ...
              <div className='col-md-4'>
                  <div className="booking-details-amenities pad-3" id="amenities-Premiummt1" style={{display:"none"}}>
                  ...
                  <div className="booking-details-amenities pad-3" id="amenities-Businessmt1" style={{display:"none"}}>
      ...
      <div className="card mb-3" id='green_oceanmt1' style={{maxWidth:"100%"}}>
          <div className="row g-0">
              <div className="col-md-3">
                  <img src="https://ocean.go2andaman.com/wp-content/uploads/2019/10/627D1A64-C7A1-4CD7-AD2C-3F6A0EF84A17_4_5005_c.jpeg?compress=true&quality=90&w=576&dpr=1.0" style={{height:"100%"}} className="img-fluid rounded-start" alt="..." />
              </div>
              ...
              <div className='col-md-4'>
                  <div className="booking-details-amenities pad-3" id="amenities-Economymt1" style={{display:"none"}}>
                  ...
                  <div className="booking-details-amenities pad-3" id="amenities-Luxurymt1" style={{display:"none"}}>
                  ...
                  <div className="booking-details-amenities pad-3" id="amenities-Royalmt1" style={{display:"none"}}>
